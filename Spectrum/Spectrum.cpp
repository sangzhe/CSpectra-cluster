...
Spectrum::Spectrum( const ISpectrum& spectrum,  const vector<Peak>& inpeaks){
    new (this)Spectrum(spectrum,inpeaks,false);
}

Spectrum::Spectrum( const ISpectrum& spectrum,  const vector<Peak>& inpeaks, bool isSortedList) {
