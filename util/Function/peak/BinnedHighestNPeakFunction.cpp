...
void BinnedHighestNPeakFunction::apply(list<IPeak *> &originalPeaks) {
    set<IPeak*> retained;
    int startPeak = 0;
...
int BinnedHighestNPeakFunction::handleBin(list<IPeak *> allpeaks, int startpeak, set<IPeak *> retained,
                                          double binBottom) {
